...
Exomiser(best)&
{% for LEVEL in LEVELS %}
    {{ '%0.1f (%0.2f)' % (np.median(EXOMISER_BEST.TEST_RANKINGS[LEVEL]), np.mean(EXOMISER_BEST.TEST_RANKINGS[LEVEL])) }}&
{% endfor %}
{% for LEVEL in LEVELS %}
    {{ '%d, %d, %d' % 
...
Exomiser(avg)&
{% for LEVEL in LEVELS %}
    {{ '%0.1f (%0.2f)' % (np.median(EXOMISER_AVERAGE.TEST_RANKINGS[LEVEL]), np.mean(EXOMISER_AVERAGE.TEST_RANKINGS[LEVEL])) }}&
{% endfor %}
{% for LEVEL in LEVELS %}
    {{ '%d, %d, %d' % 
